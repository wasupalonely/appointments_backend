...
public class UnavailabilityService {
    ...
    public Unavailability save(CreateUnavailabilityDto createUnavailabilityDto) {
        if (createUnavailabilityDto.getEndTime().before(createUnavailabilityDto.getStartTime()) ||
                createUnavailabilityDto.getStartTime().after(createUnavailabilityDto.getEndTime())) {
